...
<?php
		...
		if(count($this->godine))
		{
			...
			foreach($this->godine as $val)
			{
				...
				echo '<td><span class="modify-' . $val->idGodStud . '">' . $val->godina . '</span><input type="text" class="modifyOn-' . $val->idGodStud . '" style="display:none;" name="godina" value="' . $val->godina . '"></td>';
