...
?>
					...
					<tr style="display: none;" class="addGodStudOn">
						<form action="
							  ...
							  " method="post">
							<td><input type="text" class="form-control" name="studij" placeholder="Upišite naziv studija"></td>
                                                        <td><input type="text" class="form-control" name="godina" placeholder="Upišite godinu studija"></td>
